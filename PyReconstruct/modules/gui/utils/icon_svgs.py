...
TOOL_SVGS = {
    ...
    # knife — weight-matched chef's knife (a 1:1 vector trace of the
    # IconExperience "plain" chef's-knife icon, scaled to the 24 grid). The blade
    # is a stroked outline at the set's ~1.6px weight; the grip is filled solid
    # with a short heel/bolster stroke marking the blade-handle junction. Tip
    # lower-left, looped end upper-right, as in the reference.
    "knife": _svg(
        '<path fill="#000000" stroke="none" d="'
        'M12.47 8.62L18.19 2.91L18.84 2.53L19.59 2.44L19.69 2.34L20.62 2.53'
        'L21.09 2.81L21.56 3.28L21.94 4.12L21.94 5.25L21.56 6.09L21.00 6.66'
        'L20.53 6.94L19.88 7.03L19.78 7.12L19.41 7.12L19.31 7.03L16.22 10.12Z"/>'
        '<path fill="none" stroke="#000000" stroke-width="1.6" '
