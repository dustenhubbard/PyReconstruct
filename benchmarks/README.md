...
git worktree add --detach .claude/worktrees/wt-fork   origin/main
git worktree add --detach .claude/worktrees/wt-origin 7b2c92f
...
uv run python benchmarks/orchestrate.py \
    ...
    --checkouts fork=.claude/worktrees/wt-fork,origin=.claude/worktrees/wt-origin \
